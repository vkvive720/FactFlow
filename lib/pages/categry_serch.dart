...
class Categry_serch extends StatefulWidget {
  String serch_keyword="";
  String heading="";
  Categry_serch(this.serch_keyword,this.heading);
  // const SecondPage({super.key});

  @override
  State<Categry_serch> createState() => _SecondPageState(serch_keyword);
}

class _SecondPageState extends State<Categry_serch> {
  String serch_keyword="";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:FutureBuilder<List>(
            future: top_headlines(categry_value: serch_keyword,country_value: "us"),
